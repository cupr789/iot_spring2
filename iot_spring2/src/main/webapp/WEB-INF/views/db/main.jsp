...
var bodyLayout, aLay,bLay,dbTree,winF,popW; 
...
dhtmlxEvent(window,"load",function(){
   ...
   var bLayTabs = bLay.attachTabbar({
	   align:"left",
	   mode:"top", 
	   tabs:[{id:"a1", text:"Query Tab", active: true},{id:"a2", text:"Tab 2"}]
   });
  
   var bLayEditor = bLayTabs.tabs("a1").attachEditor();
   
   bLayEditor.attachEvent("onAccess",function(name,ev){
	    if(name=="keyup"){
		   alert(bLayEditor.getContent());
	   } 
   ...
   bToolbar.addButton("excute",1,"실행");
   bToolbar.addButton("cancle",2,"취소"); */
